...
<div className="max-w-screen-lg px-4 mx-auto flex flex-col justify-center w-full h-full items-center text-center">
    ...
    <p className="text-4xl font-bold"><span className='text-thBlue'>Question: WHY ARE SOME OF YOUR PRODUCTS RESTRICTED TO GOVERMENT AND LAW ENFORCEMENT ONLY?</span></p>

         <br />
         
         <p className="font-bold">Answer: There are no limitations on civilians possessing Night Vision Image Intensifiers
          ...
          <p className="text-4xl pt-10 font-bold"><span className='text-thBlue'>Question: Can a flashlight defeat/damage my tubes?</span></p>
         ...
         <p className="text-4xl pt-10 font-bold"><span className='text-thBlue'>Question: DO YOU SELL USED / REFURBISHED EQUIPMENT?</span></p>
